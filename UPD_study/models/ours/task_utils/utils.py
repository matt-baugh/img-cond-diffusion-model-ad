...
def accumulate_rotation(init_matrix: np.ndarray, angle: float, axes: Tuple[int, int]) -> np.ndarray:
    """
...
def accumulate_scaling(init_matrix: np.ndarray, scale: float) -> np.ndarray:
    """
